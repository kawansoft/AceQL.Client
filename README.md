...
## C# Client SDK v4.0.2 - January 2020, 20
...
C# Client SDK v4.0.2 version is compatible with AceQL HTTP v2.0+ server version. AceQL HTTP v4.0+ is required for metadata calls.
